...
class EnsembleBuffer(Buffer):
	...
	def __init__(self, cfg):
		...
		if len(demo_dataset)==1:
			self._offline_buffer.add(demo_dataset[0].unsqueeze(1)) # TODO: This is a patch to solve bug in Replay Buffer when only having 1 trajectory (we duplicate first demo)
