...
def main():
    ...
    f.supxlabel("Interaction Steps", fontsize=25, y=0.18)
    ...
    f.subplots_adjust(bottom=0.17 if SUITE == "robosuite" else (0.37 if SUITE == "humanoids" else 0.15), wspace=0.15, hspace=0.25)
    save_fig(SUITE)
