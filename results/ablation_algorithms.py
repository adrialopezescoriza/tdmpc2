...
def main():
    ...
    f, axs = plt.subplots(1, 4, figsize=(36, 8), sharex=True, sharey=True)
    axs = axs.flatten()
    ...
    legend2 = f.legend(
        ...
        legend_labels[3:], 
        loc="lower center", 
        bbox_to_anchor=(0.5, -0.2),  # Center legend horizontally below the subplots
    ...
    f.subplots_adjust(bottom=0.27, wspace=0.15, hspace=0.25)
    save_fig(f'ablation_algorithms_{SUITE}')
